...
<div class="allAuth"></div>
<div class="container-auth">
    <div class="auth-content">
        <div class="auth-content-login">
            <div class="card">
                <div class="card-header"><p class="title"><?php echo e(__('Регистрация')); ?></p></div>
                        ...
                        <div class="form-btn">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    <?php echo e(__('Зарегестрироваться')); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\ColorOnSalon\resources\views/auth/register.blade.php ENDPATH**/ ?>